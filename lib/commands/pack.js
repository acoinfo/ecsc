...
function createConfig (image) {
  return new Promise((resolve, reject) => {
    ...
    imgConfig.config.Labels['sylixos.resources.cpu.highestPrio'] = String(rtConfig.sylixos.resources.cpu.highestPrio)
    imgConfig.config.Labels['sylixos.resources.cpu.lowestPrio'] = String(rtConfig.sylixos.resources.cpu.lowestPrio)
    imgConfig.config.Labels['sylixos.resources.memory.kheapLimit'] = String(rtConfig.sylixos.resources.memory.kheapLimit)
    imgConfig.config.Labels['sylixos.resources.memory.memoryLimitMB'] = String(rtConfig.sylixos.resources.memory.memoryLimitMB)
    imgConfig.config.Labels['sylixos.resources.disk.limitMB'] = String(rtConfig.sylixos.resources.disk.limitMB)
    imgConfig.config.Labels['sylixos.resources.kernelObject.deviceLimit'] = String(rtConfig.sylixos.resources.kernelObject.deviceLimit)
    imgConfig.config.Labels['sylixos.resources.kernelObject.dlopenLibraryLimit'] = String(rtConfig.sylixos.resources.kernelObject.dlopenLibraryLimit)
    imgConfig.config.Labels['sylixos.resources.kernelObject.eventLimit'] = String(rtConfig.sylixos.resources.kernelObject.eventLimit)
    imgConfig.config.Labels['sylixos.resources.kernelObject.eventSetLimit'] = String(rtConfig.sylixos.resources.kernelObject.eventSetLimit)
    imgConfig.config.Labels['sylixos.resources.kernelObject.msgQueueLimit'] = String(rtConfig.sylixos.resources.kernelObject.msgQueueLimit)
    imgConfig.config.Labels['sylixos.resources.kernelObject.partitionLimit'] = String(rtConfig.sylixos.resources.kernelObject.partitionLimit)
    imgConfig.config.Labels['sylixos.resources.kernelObject.posixMqueueLimit'] = String(rtConfig.sylixos.resources.kernelObject.posixMqueueLimit)
    imgConfig.config.Labels['sylixos.resources.kernelObject.regionLimit'] = String(rtConfig.sylixos.resources.kernelObject.regionLimit)
    imgConfig.config.Labels['sylixos.resources.kernelObject.rmsLimit'] = String(rtConfig.sylixos.resources.kernelObject.rmsLimit)
    imgConfig.config.Labels['sylixos.resources.kernelObject.socketLimit'] = String(rtConfig.sylixos.resources.kernelObject.socketLimit)
    imgConfig.config.Labels['sylixos.resources.kernelObject.srtpLimit'] = String(rtConfig.sylixos.resources.kernelObject.srtpLimit)
    imgConfig.config.Labels['sylixos.resources.kernelObject.threadLimit'] = String(rtConfig.sylixos.resources.kernelObject.threadLimit)
    imgConfig.config.Labels['sylixos.resources.kernelObject.threadPoolLimit'] = String(rtConfig.sylixos.resources.kernelObject.threadPoolLimit)
    imgConfig.config.Labels['sylixos.resources.kernelObject.threadVarLimit'] = String(rtConfig.sylixos.resources.kernelObject.threadVarLimit)
    imgConfig.config.Labels['sylixos.resources.kernelObject.timerLimit'] = String(rtConfig.sylixos.resources.kernelObject.timerLimit)
    imgConfig.config.Labels['sylixos.resources.kernelObject.xsiipcLimit'] = String(rtConfig.sylixos.resources.kernelObject.xsiipcLimit)
    imgConfig.config.Labels['sylixos.network.ftpdEnable'] = String(rtConfig.sylixos.network.ftpdEnable)
    imgConfig.config.Labels['sylixos.network.telnetdEnable'] = String(rtConfig.sylixos.network.telnetdEnable)
